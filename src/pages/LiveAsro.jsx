        ...
        <div>
          <div
            className={`inline-block mb-2 sm:mb-3 px-2 sm:px-3 py-1 rounded text-xs ${
              isLive ? "bg-red-200 text-red-600" : "bg-orange-200 text-orange-600"
            }`}
          >
            {time}
          </div>
          ...
          <p className="text-gray-600 text-sm sm:text-base mb-3 sm:mb-4">{topic}</p>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <button
            ...
            className={`py-1.5 sm:py-2 px-4 sm:px-6 rounded-full text-sm sm:text-base ${
              isLive ? "bg-red-600 text-white hover:bg-red-700" : "bg-orange-400 text-white hover:bg-orange-500"
            }`}
          >
...
export const LiveAsro = () => {
  const sessions = [
    ...
    },
    {
      ...
      status: "live",
      image: "https://cdn.anytimeastro.com/dashaspeaks/expert/thumb/e360a589-a330-4bd6-8038-aa2bd2bae83f.png",
    },
    {
      id: 4,
      name: "Rajesh S",
      ...
      status: "scheduled",
      image: "https://cdn.anytimeastro.com/dashaspeaks/expert/thumb/acf0b565-4400-4e34-b591-9f5a1703787f.png",
    },
    {
      id: 5,
      name: "Meera K",
      ...
      status: "live",
      image: "https://cdn.anytimeastro.com/dashaspeaks/expert/thumb/3b1051d4-ba1b-4e26-b046-3e1d72f9a174.png",
    },
    {
      id: 6,
      name: "Amit R",
      ...
      status: "scheduled",
      image: "https://cdn.anytimeastro.com/dashaspeaks/expert/thumb/c83ee5f6-dc95-4830-a5e3-f1e6494dee5a.png",
    },
    {
      id: 7,
      name: "Sanjana P",
      ...
      status: "live",
      image: "https://cdn.anytimeastro.com/dashaspeaks/expert/thumb/1b8a86b0-4c82-43a7-9e88-843cb36fb01d.png",
    },
    {
      id: 8,
      name: "Vikram J",
      ...
      status: "scheduled",
      image: "https://cdn.anytimeastro.com/dashaspeaks/expert/thumb/1473fe0c-1285-4a78-910c-c6886e57c581.png",
    }
  ];
